      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-16">
          {services.map((service, index) => (
            <Card 
              key={index}
              className="group hover:shadow-organic transition-all duration-500 hover:-translate-y-3 bg-earth-cream border-0 overflow-hidden rounded-3xl"
              style={{ animationDelay: `${index * 0.2}s` }}
            >
              <CardContent className="p-8 lg:p-10 text-center">
                <div className="mb-8 flex justify-center">
                  <div className="p-4 bg-organic-green/10 rounded-2xl group-hover:bg-organic-green/20 transition-colors duration-300">
                    {service.icon}
                  </div>
                </div>
        ...
        {/* CTA Section */}
        <div className="text-center bg-gradient-organic rounded-3xl p-12 lg:p-16">
